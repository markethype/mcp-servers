...
@secure()
param oneflowApiToken string

param oneflowUserEmail string = ''
...
resource containerApp 'Microsoft.App/containerApps@2024-03-01' = {
  ...
  properties: {
    ...
    configuration: {
      ...
      secrets: [
        {
          name: 'oneflow-api-token'
          value: oneflowApiToken
        }
        {
          name: 'mcp-auth-token'
          value: mcpAuthToken
    ...
    template: {
      containers: [
        {
          name: 'oneflow-mcp'
          image: '${acr.properties.loginServer}/oneflow-mcp:${imageTag}'
          resources: {
            cpu: json('0.5')
            memory: '1.0Gi'
          }
...
output SERVICE_ONEFLOW_MCP_ENDPOINT_URL string = 'https://${containerApp.properties.configuration.ingress.fqdn}'
